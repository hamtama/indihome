...
<form role="form" method="post" action="aksitambah.php">
	...
	<div class="form-group field item row" >
		<label for="kode_kecamatan" class="col-form-label col-md-3 col-sm-3 label-align">Kode Kelurahan<span class="required">*</span></label>
		<div class="col-md-6 col-sm-6">
			<input type="number" name="kode_kelurahan" required="required" class="form-control has-feedback-left">
			<span class="fa fa-cogs form-control-feedback left" > </span>
		</div>
	</div>
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="text" name="nama_kelurahan" required="required" class="form-control has-feedback-left">
            <span class="fa fa-cogs form-control-feedback left" > </span>
        </div>
    </div>
