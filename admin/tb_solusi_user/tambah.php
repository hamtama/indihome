...
<form role="form" method="post" action="aksitambah.php">
	...
	<div class="form-group field item row" >
		<label for="nama_gejala" class="col-form-label col-md-3 col-sm-3 label-align">Solusi User<span class="required">*</span></label>
		<div class="col-md-6 col-sm-6">
			<textarea class="form-control" name="solusi" id="" cols="30" rows="5"></textarea>
		</div>
	</div>
