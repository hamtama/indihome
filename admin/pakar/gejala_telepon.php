...
<div class="x_content gejala">
	<form action="#" method="post" id="gejala_indihome">
				...
				<div class="card-box table-responsive">
					<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%" >
						<thead>
							<tr>
								<th>No</th>
								<th>Nama Gejala Telepon User</th>
								<th>Pilih Bobot</th>
							</tr>
						</thead>
						<tbody>
		...
		<button type="button" class="btn btn-primary" onclick="window.location.href='pakar_telp_user.php';">Pilih Kasus</button>
...
<script type="text/javascript">
	$(document).ready(function(){
			...
			if (kasus == 0 ){
                ...
                $('.kasus').hide('slow');
                $('.gejala').show('slow');	
                document.getElementById('judul').innerHTML = 'Pilih Gejala Telepon User';	
            }	
