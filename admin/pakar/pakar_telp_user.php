...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				<div class="x_title">
					<h2>Diagnosis Gangguan Layanan Telepon User</h2>
					...
					<div class="card bg border-success" >
						 <div class="card-header bg bg-success">
						 	<h4 class="col-md-12 text-center  text-white" id="judul">Pilih Kasus Telepon User</h4>
						 </div>
						 <div class="card-body">
								<?php 
 									require_once('kasus_telepon.php');
 									require_once('gejala_telepon.php');
								?>					 		
						 </div>
					</div>
				</div>
