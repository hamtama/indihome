...
<div class="">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				<div class="x_title">
					<h2>Diagnosis Gangguan Layanan Telepon Teknisi</h2>
					...
					<div class="card bg border-success" >
						<div class="card-header bg bg-success">
						 	<h4 class="col-md-12 text-center  text-white">GEJALA TELEPON </h4>
						</div>
						<div class="card-body">
						 	<form action="#" method="post">
							 <?php
								$no = 0;  
								$sql_gejala = mysqli_query($mysqli, "SELECT * FROM tb_gejala WHERE id_kategori = '3' ORDER BY id_gejala ASC") or die (mysqli_error($mysqli));
