...
<div class="x_content gejala">
	<form action="#" method="post" id="gejala_indihome">
		...
		<button type="button" class="btn btn-primary" onclick="window.location.href='pakar_useetv_user.php';">Pilih Kasus</button>
...
<script type="text/javascript">
	$(document).ready(function(){
			...
			if (kasus == 0 ){
                ...
                $('.kasus').hide('slow');
                $('.gejala').show('slow');	
                document.getElementById('judul').innerHTML = 'Pilih Gejala UseeTV User';	
            }	
