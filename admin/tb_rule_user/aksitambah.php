...
$hitungRule = mysqli_query($mysqli, "SELECT * FROM tb_rule_user");
...
$kategori = mysqli_query($mysqli, "SELECT * FROM tb_kasus_user WHERE id_kasus_user='$kasus'");
$id_kategori = "";
while ($row = mysqli_fetch_array($kategori)) {
    $id_kategori = $row['id_kategori'];
}
$jan = "INSERT INTO tb_rule_user VALUES(NULL, ".$rule.",".$id_kategori.", ".$gjl.", ".$kasus.")";
