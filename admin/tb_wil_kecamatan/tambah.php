...
<form role="form" method="post" action="aksitambah.php">
	...
	<div class="form-group field item row" >
		...
		<div class="col-md-6 col-sm-6">
			<input type="number" name="kode_kecamatan" required="required" class="form-control has-feedback-left">
			<span class="fa fa-cogs form-control-feedback left" > </span>
		</div>
	</div>
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="text" name="nama_kecamatan" required="required" class="form-control has-feedback-left">
            <span class="fa fa-cogs form-control-feedback left" > </span>
        </div>
    </div>
