...
if (isset($_POST['rowid'] )&& $_POST['id_rule']) {
    ...
    $sql = "SELECT * FROM tb_rule_user WHERE id_rule_user ='$id_rule'";
...
<form role="form" action="aksiedit.php" method="post">
    ...
    <div class="form-group field item row" >
		...
		<div class="col-md-6 col-sm-6">
			<select class="form-control has-feedback-left" id="rule" disabled>
                <option value="<?=$baris['id_rule_user']?>"><?=$baris['kode_rule_user']?></option>
            </select>
    ...
    $ruleBobot = mysqli_query($mysqli, "SHOW COLUMNS FROM tb_pengetahuan_user WHERE Field LIKE '%gejala%'");
    $th = 1;
    ...
    for ($i=1 ;$i<=$jumlah; $i++){
    $sql_pengetahuan = mysqli_query($mysqli, "SELECT $fetchCol[$i] FROM tb_rule_user WHERE id_rule_user='$id_rule'") or die (mysql_error($mysqli));
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                ...
                                <?php
                                $sql_pengetahuan = mysqli_query($mysqli, "SELECT $fetchCol_1[$i],id_pengetahuan_user FROM tb_pengetahuan_user WHERE id_pengetahuan_user='$id'") or die (mysql_error($mysqli));
