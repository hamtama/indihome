...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = $mysqli->query("UPDATE tb_pengetahuan_user SET 
        id_kategori = '$id_kategori',
        n_gejala_user1 = '$bobot1',
        n_gejala_user2 = '$bobot2',
        n_gejala_user3 = '$bobot3',
        n_gejala_user4 = '$bobot4',
        n_gejala_user5 = '$bobot5',
        n_gejala_user6 = '$bobot6',
        n_gejala_user7 = '$bobot7',
        presentase_user = '$persentase' WHERE id_pengetahuan_user='$id'");
        if ($sql) {
            ?>
