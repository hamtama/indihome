...
<form role="form" method="post" action="aksitambah.php">
    <div class="form-group field item row" >
        <label for="nama_kantor" class="col-form-label col-md-3 col-sm-3 label-align">Nama Kantor<span class="required">*</span></label>
        <div class="col-md-6 col-sm-6">
            <input type="text" name="nama_kantor" required="required" class="form-control has-feedback-left">
