...
<form role="form" method="post" action="aksitambah.php">
	<div class="form-group field item row" >
		<label for="kode_gejala" class="col-form-label col-md-3 col-sm-3 label-align">Kode Gejala User<span class="required">*</span></label>
	...
	<div class="form-group field item row" >
		<label for="nama_gejala" class="col-form-label col-md-3 col-sm-3 label-align">Nama Gejala User<span class="required">*</span></label>
		<div class="col-md-6 col-sm-6">
