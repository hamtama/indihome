...
if ($_POST['rowid']) {
	$id = $_POST['rowid'];
	$sql = "SELECT * FROM tb_gejala_user 
    INNER JOIN tb_kategori ON tb_kategori.id_kategori = tb_gejala_user.id_kategori
    INNER JOIN tb_bobot ON tb_gejala_user.id_bobot = tb_bobot.id_bobot WHERE id_gejala_user ='$id'";
	...
	<form action="aksiedit.php" method="post" role="form">
        <div class="form-group field item row" >
            ...
            <div class="col-md-6 col-sm-6">
                <input type="text" name="kode" value="<?php echo $baris['kode_gejala_user'] ?>" required class="form-control has-feedback-left">
                <span class="fa fa-qrcode form-control-feedback left" > </span>
            </div>
        </div>
		<div class="form-group field item row" >
			<input type="hidden" name="id" value="<?php echo $baris['id_gejala_user'] ?>">
			<label for="nama_gejala" class="col-form-label col-md-3 col-sm-3 label-align">Nama Gejala <span class="required">*</span></label>
			<div class="col-md-6 col-sm-6">
				<input type="text" name="gejala" value="<?php echo $baris['gejala_user'] ?>" required class="form-control has-feedback-left">
