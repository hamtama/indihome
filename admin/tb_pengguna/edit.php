...
if ($_POST['rowid']) {
    ...
    $sql = "SELECT * FROM tb_pengguna 
            LEFT JOIN tb_provinsi ON tb_pengguna.id_provinsi = tb_provinsi.id_provinsi
            LEFT JOIN tb_kabupaten ON tb_pengguna.id_kabupaten = tb_kabupaten.id_kabupaten 
            LEFT JOIN tb_kecamatan ON tb_pengguna.id_kecamatan = tb_kecamatan.id_kecamatan 
            LEFT JOIN tb_kelurahan ON tb_pengguna.id_kelurahan = tb_kelurahan.id_kelurahan
...
<form role="form" method="post" action="aksiedit.php">
    <input type="hidden" name="id" value="<?=$baris['id_pengguna']?>">
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="text" name="nama" required="required" class="form-control has-feedback-left" value="<?=$baris['nama_pengguna'] ?>">
    ...
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="text" name="alamat" required="required" class="form-control has-feedback-left" value="<?=$baris['alamat'] ?>">
            <span class="fa fa-cogs form-control-feedback left" > </span>
        </div>
    </div>
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="email" name="email" required="required" class="form-control has-feedback-left" value="<?=$baris['email'] ?>">
            <span class="fa fa-cogs form-control-feedback left" > </span>
        </div>
    </div>
    <div class="form-group field item row" >
        ...
        <div class="col-md-6 col-sm-6">
            <input type="number" name="no_telp" required="required" class="form-control has-feedback-left" value="<?=$baris['no_telp'] ?>">
            <span class="fa fa-cogs form-control-feedback left" > </span>
        </div>
    </div>
