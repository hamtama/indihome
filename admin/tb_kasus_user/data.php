	...
	<div class="row">
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				...
				<a class="btn btn-success" href="../tb_kasus/data.php" id="1"><i class="fa fa-cube">  Kasus Teknisi</i></a>
				<div class="x_content">
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" width="100%">
									...
									<tbody>
										<?php
										$no = 1;
										$query = "SELECT * FROM tb_kasus_user
													INNER JOIN  tb_kategori ON tb_kasus_user.id_kategori = tb_kategori.id_kategori 
													INNER JOIN tb_bobot ON tb_kasus_user.id_bobot = tb_bobot.id_bobot WHERE 1 ORDER BY kode_kasus_user ASC";
										...
										<tr>
											<td style="width:10%">
												<a class="btn btn-warning btn-xs"  data-toggle="modal" href="#myModal" id="custId" data-target="#myModal" data-id="<?=$row['id_kasus_user'] ?>"><i class="fa fa-pencil"></i></a>
												<button class="btn btn-danger btn-xs" onclick="javascript:delete_id(<?=$row['id_kasus_user']?>)" ><i class="fa fa-trash"></i></button>
											</td>
											<td><?=$no++?>.</td>
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h4 class="modal-title" >Tambah Data Kasus User</h4>
								...
								<div class="modal fade bs-example-modal-lg"  id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h4 class="modal-title" >Edit Data Kasus User</h4>
												<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
												</button>
											</div>
											<div class="modal-body">
